                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-posts--id-">GET api/posts/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-posts--id--status">
                                <a href="#endpoints-PUTapi-posts--id--status">PUT api/posts/{id}/status</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-posts--postId--chat">
                                <a href="#endpoints-POSTapi-posts--postId--chat">POST api/posts/{postId}/chat</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 30. Example: <code>7</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 10000. Example: <code>17</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"raw_content\": \"architecto\",
    \"campaign_blueprint_id\": 16
}"
</code></pre></div>
...
<p>The ID of the post. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-posts--id--status">PUT api/posts/{id}/status</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-posts--id--status"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the post. Example: <code>architecto</code></p>
...
<ul style="list-style-type: square;"><li><code>draft</code></li> <li><code>archived</code></li> <li><code>posted</code></li></ul>
                    ...
                    <h2 id="endpoints-POSTapi-posts--postId--chat">POST api/posts/{postId}/chat</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="postId"                data-endpoint="POSTapi-posts--postId--chat"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
